    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
                ...
                <div class="card-body pt-9 pb-0">
                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold"
                        ...
                        <li class="nav-item mt-2" role="presentation">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" id="kt_visao_geral_btn"
                               data-bs-toggle="tab" href="#kt_visao_geral" aria-selected="false" role="tab"
                               tabindex="-1"
                            >Visão Geral</a>
                        </li>
                        <li class="nav-item mt-2" role="presentation">
                            <a id="kt_configuracoes_btn" class="nav-link text-active-primary ms-0 me-10 py-5"
                               data-bs-toggle="tab" href="#kt_configuracoes" aria-selected="true" role="tab">
                                Configurações</a>
                        </li>
                    </ul>
                    <!--begin::Navs-->
            ...
            <div class="tab-content" id="myTabContent">
                {{--begin::Visao Geral --}}
                <div class="tab-pane fade active show card mb-5 mb-xl-10" id="kt_visao_geral" role="tabpanel">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span class="fw-bold fs-6 text-gray-800 me-2">{{ $client->phoneFormated }}</span>
                                <span class="badge badge-success">Verificado</span>
                            </div>
                        </div>

                        <div class="row mb-7">
                            <label class="col-lg-4 fw-semibold text-muted">Estado Civil</label>
                            <div class="col-lg-8">
                                <a href="#"
                                   class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $client->marital_status ?? "não informado"}}</a>
                            </div>
                        </div>

                        <div class="row mb-7">
                            <label class="col-lg-4 fw-semibold text-muted">Origem
                                <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                   aria-label="Country of origination" data-kt-initialized="1"></i>
                            </label>
                            <div class="col-lg-8">
                                <span class="fw-bold fs-6 text-gray-800">não informado</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {{--begin::Configurações --}}
                <div class="tab-pane fade card mb-5 mb-xl-10" id="kt_configuracoes" role="tabpanel">
                    <!--begin::Card -->
                    <div class="card-header cursor-pointer">
                        <div class="card-title m-0">
                            <h3 class="fw-bold m-0">Detalhes do Perfil</h3>
                    ...
                    <!--begin::Formulário Update -->
                    <div class="card-body p-9">
                        <form id="kt_account_profile_details_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                              novalidate="novalidate" action="{{ route('admin.clients.update', $client->id) }}" method="PUT">
                            @csrf
                            <div class="card-body">
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                 style="background-image: url('{{ asset("metronic/media/avatars/blank.png") }}')"></div>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Nome
                                        Completo</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="company"
                                               class="form-control form-control-lg form-control-solid"
                                               placeholder="Nome Completo" value="{{ old('name', $client->name) }}">
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Companhia</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="company"
                                               class="form-control form-control-lg form-control-solid"
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="tel" name="phone"
                                               ...
                                               value="{{ old('phone', $client->phoneFormated) }}">
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                    </div>
                                </div>

                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">Site da empresa</label>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="country" aria-label="Select a Country" data-control="select2"
                                                ...
                                                data-select2-id="select2-data-10-stq0" tabindex="-1" aria-hidden="true"
                                                data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-12-rhnq">Select a Country...
                                            </option>
                                            <option data-kt-flag="{{ asset('metronic/media/flags/afghanistan.svg') }}"
                                            ...
                                            <option data-kt-flag="flags/zimbabwe.svg" value="ZW">Zimbabwe</option>
                                                       ...
                                                       dir="ltr" data-select2-id="select2-data-11-nm5h"
                                                       style="width: 100%;"><span class="selection"><span
                                                        ...
                                                        aria-labelledby="select2-country-nu-container"
                                                        aria-controls="select2-country-nu-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-country-nu-container" role="textbox"
                                                            aria-readonly="true" title="Select a country..."><span
                                                                class="select2-selection__placeholder">Selecione um pais...</span></span><span
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Idioma</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="language" aria-label="Select a Language" data-control="select2"
                                                ...
                                                data-select2-id="select2-data-13-7xow" tabindex="-1" aria-hidden="true"
                                                data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-15-hhko">Select a Language...
                                            </option>
                                            ...
                                            <option data-kt-flag="flags/taiwan.svg" value="zh-tw">繁體中文 - Traditional
                                                Chinese
                                                       ...
                                                       dir="ltr" data-select2-id="select2-data-14-yqm0"
                                                       style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-language-7o-container"
                                                        aria-controls="select2-language-7o-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-language-7o-container" role="textbox"
                                                            aria-readonly="true" title="Select a language..."><span
                                                                class="select2-selection__placeholder">Selecione um idioma...</span></span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <div class="form-text">Selecione um idioma preferido, incluindo data, hora e
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select name="timezone" aria-label="Select a Timezone" data-control="select2"
                                                ...
                                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                                data-select2-id="select2-data-16-7g4s" tabindex="-1" aria-hidden="true"
                                                data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-18-xs0c">Select a Timezone..
                                            </option>
                                            ...
                                            <option data-bs-offset="46800" value="Nuku'alofa">(GMT+13:00) Nuku'alofa
                                                       ...
                                                       dir="ltr" data-select2-id="select2-data-17-r848"
                                                       style="width: 100%;"><span class="selection"><span
                                                        class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                                        role="combobox" aria-haspopup="true" aria-expanded="false"
                                                        tabindex="0" aria-disabled="false"
                                                        aria-labelledby="select2-timezone-wh-container"
                                                        aria-controls="select2-timezone-wh-container"><span
                                                            class="select2-selection__rendered"
                                                            id="select2-timezone-wh-container" role="textbox"
                                                            aria-readonly="true" title="Select a timezone.."><span
                                                                class="select2-selection__placeholder">Fuso horário</span></span><span
                                                            class="select2-selection__arrow" role="presentation"><b
                                                                role="presentation"></b></span></span></span><span
                                                    class="dropdown-wrapper" aria-hidden="true"></span></span>
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">Moeda</label>
                                    <div class="col-lg-8 fv-row">
                                        <select name="currnecy" aria-label="Select a Currency" data-control="select2"
                                                data-placeholder="Select a currency.."
                                                class="form-select form-select-solid form-select-lg select2-hidden-accessible"
                                                data-select2-id="select2-data-19-7ex4" tabindex="-1" aria-hidden="true"
                                                data-kt-initialized="1">
                                            <option value="" data-select2-id="select2-data-21-dra2">Select a currency..
                                            </option>
                                        ...
                                        <span class="select2 select2-container select2-container--bootstrap5" dir="ltr"
                                              data-select2-id="select2-data-20-p667" style="width: 100%;">
                                        <span class="selection">
                                            <span class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                                  role="combobox" aria-haspopup="true" aria-expanded="false"
                                                  tabindex="0" aria-disabled="false"
                                                  aria-labelledby="select2-currnecy-ig-container"
                                                  aria-controls="select2-currnecy-ig-container">
                                                <span class="select2-selection__rendered"
                                                      id="select2-currnecy-ig-container"
                                                      role="textbox" aria-readonly="true" title="Select a currency..">
                                                    <span class="select2-selection__placeholder">Selecione uma opção</span>
                                                </span>
                                ...
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label required fw-semibold fs-6">Comunicação</label>
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                ...
                                <div class="row mb-0">
                                    <label class="col-lg-4 col-form-label fw-semibold fs-6">Permitir marketing</label>
                                    <div class="col-lg-8 d-flex align-items-center">
                    ...
                    <!--end::Formulário Update -->
                </div>
                {{--end::Configurações --}}
            </div>

            <!--begin::Metodo de Login-->
            <div class="card mb-5 mb-xl-10" id="kt_signin_method">
                    ...
                    <div class="card-body border-top p-9">
                        <div class="d-flex flex-wrap align-items-center">
                            <div id="kt_signin_email">
                                <div class="fs-6 fw-bold mb-1">Endereço eletrônico</div>
                                <div class="fw-semibold text-gray-600">{{ $client->email }}</div>
                            </div>
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-6 mb-4 mb-lg-0">
                                            <div class="fv-row mb-0">
                                                <label for="email" class="form-label fs-6 fw-bold mb-3">Novo email</label>
                                                <input type="email" class="form-control form-control-lg form-control-solid" id="email" placeholder="Endereço de email" name="email" value="{{ old($client->email) }}"/>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="fv-row mb-0">
                                                <label for="email_confirmation" class="form-label fs-6 fw-bold mb-3">Confirmar email</label>
                                                <input type="email" class="form-control form-control-lg form-control-solid" name="email_confirmation" id="email_confirmation"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-0">
                                                <label for="confirmpassword" class="form-label fs-6 fw-bold mb-3">Confirme
                                                    a nova senha</label>
                                                <input type="password"
                                                       class="form-control form-control-lg form-control-solid"
                                    ...
                                    <div class="form-text mb-5">A senha deve ter pelo menos 8 caracteres e conter
                                        símbolos
                                    </div>
                                    <div class="d-flex">
                                        ...
                                        <button id="kt_password_cancel" type="button"
                                                class="btn btn-color-gray-400 btn-active-light-primary px-6">Cancelar
                                        </button>
                                    </div>
                                </form>
                                <!--end::Form Troca Senha-->
                            </div>
                            <div id="kt_signin_password_button" class="ms-auto">
                                <button class="btn btn-light btn-active-light-primary">Mudar Senha</button>
                            </div>
                        </div>
                        ...
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                            ...
                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                <div class="mb-3 mb-md-0 fw-semibold">
                                    <h4 class="text-gray-900 fw-bold">Proteja sua conta</h4>
                                    <div class="fs-6 text-gray-700 pe-7">A autenticação de dois fatores adiciona uma
                                        camada extra de segurança à sua conta. Para fazer login, além disso, você
                                        precisará fornecer um código de 6 dígitos
                                    </div>
                                </div>
                                <a href="#" class="btn btn-primary px-6 align-self-center text-nowrap"
                                   data-bs-toggle="modal"
                                   data-bs-target="#kt_modal_two_factor_authentication">Habilitar</a>
                            </div>
                        </div>
                    </div>
                </div>
