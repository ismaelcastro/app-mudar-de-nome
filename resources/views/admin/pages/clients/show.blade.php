                    ...
                    <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold" role="tablist">
                        <li class="nav-item mt-2" role="presentation">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5 active" id="kt_visao_geral_btn"
                               data-bs-toggle="tab" href="#kt_visao_geral" aria-selected="false" role="tab" tabindex="-1"
                            >Visão Geral</a>
                        </li>
                        <li class="nav-item mt-2" role="presentation">
                ...
                <div class="tab-pane fade active show card mb-5 mb-xl-10" id="kt_visao_geral" role="tabpanel">
                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <a href="#" class="fw-semibold fs-6 text-gray-800 text-hover-primary">{{ $client->marital_status ?? "não informado"}}</a>
                            </div>
                        </div>
                        <!--end::Input group-->
                        <!--begin::Input group-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input-wrapper w-125px h-125px"
                                             style="background-image: url('{{ asset("metronic/media/avatars/300-1.jpg") }}')"></div>
                                    ...
                                    <select name="currnecy" aria-label="Select a Currency" data-control="select2"
                                        ...
                                        <option data-kt-flag="flags/switzerland.svg" value="CHF">
                                            CHF&nbsp;-&nbsp;Swiss franc
                                                   ...
                                                   dir="ltr" data-select2-id="select2-data-20-p667"
                                                   style="width: 100%;"><span class="selection"><span
                                                    class="select2-selection select2-selection--single form-select form-select-solid form-select-lg"
                                                    role="combobox" aria-haspopup="true" aria-expanded="false"
                                                    tabindex="0" aria-disabled="false"
                                                    aria-labelledby="select2-currnecy-ig-container"
                                                    aria-controls="select2-currnecy-ig-container"><span
                                                        class="select2-selection__rendered"
                                                        id="select2-currnecy-ig-container" role="textbox"
                                                        aria-readonly="true" title="Select a currency.."><span
                                                            class="select2-selection__placeholder">Selecione uma opção</span></span><span
                                                        class="select2-selection__arrow" role="presentation"><b
                                                            role="presentation"></b></span></span></span><span
                                                class="dropdown-wrapper" aria-hidden="true"></span></span>
                                </div>
                ...
                <div id="kt_account_settings_signin_method" class="collapse show">
                    ...
                    <div class="card-body border-top p-9">
                                    ...
                                    <div class="row mb-6">
                                        <div class="col-lg-6 mb-4 mb-lg-0">
                                            <div class="fv-row mb-0">
                                                <label for="emailaddress" class="form-label fs-6 fw-bold mb-3">Novo email</label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="fv-row mb-0">
                                                <label for="confirmemailpassword" class="form-label fs-6 fw-bold mb-3">COnfirmar senha</label>
                        ...
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            ...
                            <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                                ...
                                <form id="kt_signin_change_password" class="form" novalidate="novalidate">
                                    ...
                                    <div class="d-flex">
                                        <button id="kt_password_submit" type="button" class="btn btn-primary me-2 px-6">Atualizar a senha</button>
                        ...
                        <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6">
                            <!--begin::Icon-->
                            {!! file_get_contents('metronic/media/icons/duotune/general/gen048.svg') !!}
                            <!--end::Icon-->
                            <!--begin::Wrapper-->
                            <div class="d-flex flex-stack flex-grow-1 flex-wrap flex-md-nowrap">
                                ...
                                <!--end::Content-->
                                <!--begin::Action-->
                                <a href="#" class="btn btn-primary px-6 align-self-center text-nowrap" data-bs-toggle="modal" data-bs-target="#kt_modal_two_factor_authentication">Habilitar</a>
                                <!--end::Action-->
                            </div>
                            <!--end::Wrapper-->
                        </div>
