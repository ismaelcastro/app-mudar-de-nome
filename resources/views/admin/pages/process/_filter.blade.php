            ...
            <ul class="nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="javascript:void(0);" onclick="deselectSatrFilter('#procedural_step', '#form-searh-case');" >Exibir todas</a>
                        <div class="dropdown-divider"></div>
                        @foreach ($procedural_step_list as $stage_case_key => $stage_case_value)
                        <a class="dropdown-item" href="javascript:void(0);" onclick="addSatrFilter('#procedural_step', '{{$stage_case_key}}','#form-searh-case');" >{{$stage_case_value}}</a>
                        @endforeach
                    </div>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarEtapaDropdown">
                        ...
                        <a class="dropdown-item" href="javascript:void(0);" onclick="addSatrFilter('#procedural_step', 'com_advogado','#form-searh-case');" >
                            Com Advogado
                        </a>
                        <a class="dropdown-item" href="javascript:void(0);" onclick="addSatrFilter('#procedural_step', 'com_requerente','#form-searh-case');" >
                            Com Requerente
                        </a>
