<div class="row">
    <div class="col-sm-8">
        <div class="row">
            ...
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    {{ Form::text('name', null, ['class' => $errors->has('name') ?  'form-control is-invalid' : 'form-control', 'readonly' => isset($processCategory->id) ? true : false ]) }}
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    {{ Form::label('etapa_mautic', 'Etapa como esta no Mautic') }}
                    {{ Form::text('etapa_mautic', null, ['class' => $errors->has('etapa_mautic') ?  'form-control is-invalid' : 'form-control', 'rows' => 4, 'cols' => 40]) }}
                    @include('admin.partials._help_block',['field' => 'etapa_mautic'])
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    {{ Form::label('status_call', 'Status') }}
                    {{  Form::select('status_call', $status_list_call,null,['class' => $errors->has('status_call') ?  'form-control is-invalid' : 'form-control']) }}
                    @include('admin.partials._help_block',['field' => 'status_call'])
                </div>
            </div>
        </div>
