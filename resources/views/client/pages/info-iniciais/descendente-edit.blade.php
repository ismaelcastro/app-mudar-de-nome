...
<div class="row p-b-30">
    <ul class="breadcrumb">
        ...
        <li>Dados do(a) {{$client->name}} Descendente</li>
    </ul>
    <div class="col-12 ico-group p-b-30">        
        <h2>Dados do(a) {{$client->name}}</h2>
        <p>
    ...
    {{ Form::model($client, ['route' => ['client.iniciais.descendente.dados.update',$client->id], 'method' => 'PUT' ]) }}
