...
<head>
    ...
    <title>Retificação Gerencia Net</title>
    <style>
        /*!
...
<body>
    ...
    <div id="contentarea" class="container connectSortable ui-sortable ui-droppable" style="background: rgb(255, 255, 255); border-width: 1px 0px 0px; border-right-style: initial; border-bottom-style: initial; border-left-style: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: initial; border-image: initial; border-top-style: solid; border-top-color: #FFFFFF; max-height: 500px; overflow: auto; zoom: 1; min-height: 50px;">
        ...
        na Cláusula 1.1, o(a)&nbsp;<b>CONTRATANTE</b> pagará ao <b>CONTRATADO</b><span style="color: inherit;">, honorários no valor de <b>R$&nbsp;</b></span><span class="VALOR_TOTAL token_d4s"><b>{{$amount}}</b></span>&nbsp;&nbsp;(<i><span class="EXTENSO token_d4s">{{$by_extenso}}</span></i>)&nbsp;pagos via depósito bancário somente em caso de procedência no processo de Retificação de Registro, devendo ser pagos em até&nbsp;<b>03</b>&nbsp;(<i><u>três</u></i>) dias úteis após a sentença, em:<span style="color: inherit;"><br></span></p></div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"><b></b></span></p></div><div class="edit"><div class="edit" contenteditable="true"><p><b>Banco&nbsp;Bradesco - 237</b></p></div><div class="edit" contenteditable="true"><p><b>Agência:</b>&nbsp;2503</p></div><div class="edit" contenteditable="true"><p><b>Conta Corrente:</b>&nbsp;0403262-4<br></p></div><div class="edit" contenteditable="true"><p><b>Titularidade:</b>&nbsp;Thiago Ratsbone</p></div><div class="edit" contenteditable="true"><p><b>CPF:&nbsp;</b>359.637.798-63</p></div></div><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"></span></p></div></blockquote><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>Parágrafo Único –</b>&nbsp;Nos processos em houver mais de um pedido será considerado êxito a sentença parcialmente procedente, devendo os honorários advocatícios "<i>Ad Exitum</i>" serem pagos integralmente.&nbsp;&nbsp;<span style="color: inherit;"></span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.3 –</b>&nbsp;&nbsp;Iniciados os serviços especificados no objeto, ainda que haja mudança de patrocinador da causa, os honorários serão devidos ao&nbsp;<b>CONTRATADO</b>&nbsp;nos termos em que contratados.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.6 -&nbsp;</b><span style="color: inherit;">O meio de comunicação estabelecido, para contato com os profissionais contratados, será realizado<b style="text-decoration-line: underline;"> exclusivamente</b> por meio de ligações para o telefone <b style="text-decoration-line: underline;">(11) 5083-0000 </b>ou e-mail <b style="text-decoration-line: underline;">consulta@ratsbonemagri.com.br</b>, ficando totalmente excluída a possibilidade de contatos e consultas via Redes Sociais ou Whatsapp, exceto quando necessários ao esclarecimento de informações requisitados pelos profissionais contratados, exclusivamente em horário comercial (9h às 18h) em dias úteis.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
