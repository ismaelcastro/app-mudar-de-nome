...
<head>
    ...
    <title>Retificação À Vista</title>
    <style>
        /*!
...
<body>
    ...
    <div id="contentarea" class="container connectSortable ui-sortable ui-droppable" style="background: rgb(255, 255, 255); border-width: 1px 0px 0px; border-right-style: initial; border-bottom-style: initial; border-left-style: initial; border-right-color: initial; border-bottom-color: initial; border-left-color: initial; border-image: initial; border-top-style: solid; border-top-color: #FFFFFF; max-height: 500px; overflow: auto; zoom: 1; min-height: 50px;">
        ...
        <div class="ui-draggable ui-dragbox-outlined"><div contenteditable="true">
        <h1></h1><div class="edit" contenteditable="true"><p align="center"><span style="font-size: 18px;"><b style=""><span style="font-family: Sanchez, serif;">INSTRUMENTO PARTICULAR DE CONTRATO DE PRESTAÇÃO </span></b></span></p>  <p align="center"><span style="font-size: 18px;"><b style=""><span style="font-family: Sanchez, serif;">DE SERVIÇOS DE ASSESSORIA JURÍDICA</span></b></span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px; display: block;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        ...
        <p></p><div class="edit" contenteditable="true"><p><b>CONTRATANTE:</b>&nbsp; &nbsp; &nbsp; &nbsp;<b> &nbsp;<span class="NOME_DO_CLIENTE token_d4s">{{$client_name}}</span></b>,&nbsp;<span class="NACIONALIDADE token_d4s">{{$client_nationality}}</span>,&nbsp;<span class="ESTADO_CIVIL token_d4s">{{$marital_status}}</span>,&nbsp;<span class="PROFISSAO token_d4s">{{$occupation}}</span>, portador (a) da Cédula de Identidade RG sob o n.°&nbsp;<span class="No_RG token_d4s">{{$rg}}</span>&nbsp;&nbsp;e inscrito (a) no CPF/MF sob o n.º&nbsp;<span class="No_CPF token_d4s">{{$cpf}}</span>&nbsp;, residente e domiciliado (a) na&nbsp;<span class="ENDERECO token_d4s">{{$address}}</span>&nbsp;,&nbsp;<span class="COMPLEMENTO token_d4s">{{$complement}}</span>&nbsp;,&nbsp;<span class="BAIRRO token_d4s">{{$neighborhood}}</span>&nbsp;,&nbsp;<span class="CIDADE token_d4s">{{$city}}</span>&nbsp;&nbsp;-&nbsp;<span class="ESTADO token_d4s">{{$state}}</span>&nbsp;&nbsp;CEP&nbsp;<span class="N_CEP token_d4s">{{$zip_code}}</span>&nbsp;.<b></b></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p></p><div class="edit" contenteditable="true"><p><b>CONTRATADO:&nbsp;</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<b>RATSBONE &amp; MAGRI ADVOGADOS ASSOCIADOS</b>, sociedade de advogados inscrita na Ordem dos Advogados do Brasil – OAB sob n.º 30.151, e no CNPJ sob n.º 37.837.462/0001-78 com sede na Avenida Moaci, 5º andar, conjuntos n.º 506-507, Planalto Paulista, São Paulo/SP, neste ato representada, nos termos dos seus atos constitutivos, por seu sócio administrador&nbsp;<b>THIAGO RATSBONE</b>, brasileiro, solteiro, advogado, inscrito na OAB/SP sob o n.º 333.171 e no CPF/MF sob o n.º 359.637.798-63.&nbsp; &nbsp;<b>&nbsp; &nbsp;</b></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><div class="edit" contenteditable="true"><p style="text-align: justify;">As Partes, resolvem, de comum acordo e na melhor forma de direito, por livre e espontânea vontade, celebrar o presente instrumento particular de acordo com as cláusulas e condições previstas nos itens seguintes, a saber:<b></b></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA PRIMEIRA - DO OBJETO DO CONTRATO</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>1.1 – </b>O presente instrumento particular tem por objeto a prestação de serviços de advocacia, a serem executados em conformidade com os poderes gerais e especiais outorgados ao <b>CONTRATADO</b> nas procurações “<i>Ad Judicia et Extra</i>” firmadas pelo(a)&nbsp;<b>CONTRATANTE</b>&nbsp;nesta mesma data, a saber:&nbsp;</p><p><br></p><p></p><ul><li>Ajuizamento de<b>&nbsp;Ação de Retificação ou Suprimento de Registro Civil.</b></li></ul><p></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><b>1.2 –</b>&nbsp;Para tanto, o&nbsp;<b>CONTRATADO</b>&nbsp;prestará serviços referentes à assessoria jurídica, triagem de documentação, emissão de guias judiciais, elaboração de petições, acompanhamento em audiências até o trânsito em julgado da referida ação movida pelo(a)&nbsp;<b>CONTRATANTE</b>.<br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA SEGUNDA - DA FORMA</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>2.1 – </b>O <b>CONTRATADO</b> deverá praticar todos os atos relacionados ao exercício da advocacia, obrigações tipicamente de meio, particularmente aqueles constantes no Estatuto da Ordem dos Advogados do Brasil, assim como o que for especificado na outorga das procurações “<i>Ad Judicia et Extra</i>”, com a diligência habitual que se presume da atuação profissional.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>2.2 –</b>&nbsp;O(A)&nbsp;<b>CONTRATANTE</b> se compromete a fornecer ao <b>CONTRATADO</b> toda documentação necessária para execução do serviço ora contratado, não se responsabilizando o <b>CONTRATADO</b>, por quaisquer prejuízos em face da desídia do(a)&nbsp;<b>CONTRATANTE</b>.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>2.3 –</b>&nbsp;A ação deverá ser ajuizada no prazo máximo de <b>7</b>&nbsp;(<i>sete</i>) dias úteis, contados da efetiva aprovação de todos os documentos solicitados pelo&nbsp;<b>CONTRATADO</b>, incluindo comprovante de guias processuais.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>2.4 –</b>&nbsp;O(A)&nbsp;<b>CONTRATANTE</b> declara ter conhecimento de que a prestação de serviços advocatícios é obrigação de meio e não de resultado.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA TERCEIRA - DOS HONORÁRIOS ADVOCATÍCIOS</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.1 –</b>&nbsp;&nbsp;Pelos serviços descritos
        na Cláusula 1.1, o(a)&nbsp;<b>CONTRATANTE</b> pagará ao <b>CONTRATADO</b><span style="color: inherit;">, honorários no valor de <b>R$&nbsp;</b></span><span class="VALOR_TOTAL token_d4s"><b>{{$amount}}</b></span>&nbsp;&nbsp;(<i><span class="EXTENSO token_d4s">{{$by_extenso}}</span></i>)&nbsp;pagos via depósito bancário dia&nbsp;<span class="DATA token_d4s">{{$payment_date}}</span>&nbsp;, em:<span style="color: inherit;"></span><span style="color: inherit;"><br></span></p></div><blockquote style="margin: 0 0 0 40px; border: none; padding: 0px;"><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"><b>Banco&nbsp;Bradesco - 237</b></span></p></div><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"><b>Agência:</b>&nbsp;2503</span></p></div><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>Conta Corrente:</b>&nbsp;0403262-4<br></p></div><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"><b>Titularidade:</b>&nbsp;</span><span style="color: inherit;">Thiago Ratsbone</span></p></div><div class="edit" contenteditable="true"><p style="text-align: justify;"><span style="color: inherit;"><b>CPF:&nbsp;</b>359.637.798-63</span></p></div></blockquote><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.2 –</b>&nbsp;&nbsp;Sempre que houver falta de pagamento das parcelas dentro dos prazos pactuados, sejam integrais ou parcelados, fica acordada a aplicação de multa contratual de&nbsp;<b>10%</b> (<i><u>dez por cento</u></i>), juros de mora de <b>1%</b> (<i><u>um por cento</u></i>) ao mês e atualização monetária pelo índice INPC.<span style="color: inherit;"></span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.3 –</b>&nbsp; Persistindo o atraso, por período superior a&nbsp;<b>03</b>&nbsp;(<i>três</i>) meses&nbsp;consecutivos, o&nbsp;<b>CONTRATADO</b>&nbsp;poderá suspender a execução dos serviços, bem como considerar rescindido o presente instrumento, comunicando o(a)&nbsp;<b>CONTRATANTE</b>&nbsp;para que constitua novo representante legal no prazo de até 10 dias nos termos do art. 5º, § 3º da lei 8906/94 e art. 6º do Regulamento Geral do Estatuto.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.4 –</b>&nbsp; Os honorários efetivamente pagos, <b><u>não são passíveis de devolução</u></b> em qualquer hipótese, dada sua natureza alimentar.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p style="text-align: justify;"><b>3.5 –</b>&nbsp;&nbsp;Iniciados os serviços especificados no objeto, ainda que haja mudança de patrocinador da causa, os honorários serão devidos ao&nbsp;<b>CONTRATADO</b>&nbsp;nos termos em que contratados.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA QUARTA - DAS DESPESAS</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>4.1 - </b>Todas as despesas oriundas do custeio da ação, correrão por conta do(a)&nbsp;<b>CONTRATANTE</b>, que deverá adiantá-las ou reembolsá-las prontamente, as despesas extrajudiciais e judiciais, locomoção do patrono ao fórum, reconhecimento de firmas, fotocópias, autenticações, emolumentos, e quaisquer outras que se fizerem necessárias à melhor execução possível dos serviços ora contratados, mediante apresentação de demonstrativos analíticos pelo&nbsp;<b>CONTRATADO</b>.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA QUINTA - DO SIGILO</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>5.1 - </b>O <b>CONTRATADO</b>, por si, seus sócios, administradores, empregados e subcontratados, obriga-se a guardar absoluto sigilo sobre dados, informações e negócios do(a)&nbsp;<b>CONTRATANTE</b>, que por qualquer motivo venham a ser do seu conhecimento em virtude da execução dos serviços ajustados, respondendo nos termos dos capítulos próprios contidos no Código Civil.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>5.2 - </b>Reciprocamente, e nas mesmas condições do item 5.1, o(a)&nbsp;<b>CONTRATANTE</b> manterá sigilo sobre condições contratuais, metodologia e técnicas empregadas pelo <b>CONTRATADO</b> na execução dos serviços jurídicos previstos neste instrumento.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA SEXTA - DO PRAZO E RESCISÃO</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>6.1 - </b>Este contrato tem vigência desde a sua assinatura até até o trânsito em julgado da referida ação.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>6.2 - </b>Em caso de desistência por parte do(a)&nbsp;<b>CONTRATANTE</b>, antes de iniciados os serviços especificados na Cláusula 1.1, serão devidos ao&nbsp;<b>CONTRATADO</b>, a título de honorários por assessoria e consultoria jurídica, o valor de <b>01</b> (<i><u>um</u></i>) salário mínimo vigente.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>Parágrafo Único -&nbsp;</b>Considera-se desistência a recusa por parte do(a)&nbsp;<b>CONTRATANTE</b>&nbsp;por período superior a&nbsp;<b>03</b>&nbsp;(<i><u>três</u></i>) meses&nbsp;a partir da assinatura do presente instrumento, em apresentar os documentos ou certidões necessárias para a propositura da presente demanda, ou que por ventura venham a ser solicitadas pelo Ministério Público durante a tramitação do processo.</p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA SÉTIMA - DA EXEQUIBILIDADE DO INSTRUMENTO</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>7.1 -&nbsp;</b><span style="color: inherit;">A inadimplência dos pagamentos convencionados na Cláusula 3.1 concede poderes ao <b>CONTRATADO</b>&nbsp;de mover competente ação de execução contra o(a)&nbsp;<b>CONTRATANTE</b> para receber a importância devida ao Juízo, sendo este contrato reconhecido pelas partes como título executivo extrajudicial, a rigor do disposto no art. 585, II do CPC e artigo 24 da Lei n. 8.906 de 04 de julho de 1994 EOAB.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA OITAVA - DAS DISPOSIÇÕES GERAIS</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.1 -&nbsp;</b><span style="color: inherit;">O(A)&nbsp;<b>CONTRATANTE</b> por meio deste contrato autoriza expressamente o <b>CONTRATADO</b> a não atuar ou interpor recursos que julgue incabíveis, infundados, inócuos, sem resultado prático útil e/ou meramente protelatórios.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.2 -&nbsp;</b><span style="color: inherit;">O <b>CONTRATADO</b> não garante o resultado favorável ao&nbsp;<b>CONTRATANTE</b>&nbsp;mas, compromete-se a usar de todos os meios jurídicos, legais, morais e legítimos para defender os interesses do(a)&nbsp;<b>CONTRATANTE</b>.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.3 -&nbsp;</b><span style="color: inherit;">O(s) <b>CONTRATANTE</b>(s) é totalmente responsável pelo comparecimento nos locais e horários indicados, bem como se compromete na obtenção da documentação necessária para viabilizar a ação contratada pelo presente instrumento, sendo responsável por eventual perda de prazo ou influência no resultado pela inobservância de algum destas obrigações.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.4 -&nbsp;</b><span style="color: inherit;">Em quaisquer casos de arquivamento, extinção do processo ou improcedência da ação em que tenha o(a)&nbsp;<b>CONTRATANTE</b>&nbsp;dado causa por não comparecimento sem motivo justificado, inverdade das informações ou documentos, serão cobrados honorários integrais nos valores ajustados no presente contrato.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.5 -&nbsp;</b><span style="color: inherit;">Fica definido que toda e qualquer comunicação a ser feita pelo <b>CONTRATADO</b> ao&nbsp;<b>CONTRATANTE</b>&nbsp;ocorrerá pelo endereço eletrônico <span class="e_mail token_d4s">{{$email}}</span>, sendo que a simples remessa de mensagens para tal e-mail presume o recebimento da informação pelo(a)&nbsp;<b>CONTRATANTE</b>, o qual se obriga a informar qualquer alteração.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>8.6 -&nbsp;</b><span style="color: inherit;">O meio de comunicação estabelecido, para contato com os profissionais contratados, será realizado<b><u> exclusivamente por meio de ligações para o telefone (11) 5083-0000 ou e-mail consulta@ratsbonemagri.com.br</u></b>, ficando totalmente excluída a possibilidade de contatos e consultas via Redes Sociais ou Whatsapp, exceto quando necessários ao esclarecimento de informações requisitados pelos profissionais contratados, exclusivamente em horário comercial (9h às 18h) em dias úteis.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA NONA - DO FORO</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>9.1 -&nbsp;</b><span style="color: inherit;">As partes elegem o foro da cidade de São Paulo/SP para conhecer das questões porventura emergentes da presente relação contratual, com a expressa renúncia de qualquer outro, por mais privilegiado que possa vir a ser.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p><br></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div contenteditable="true">
        <h1><div class="edit" contenteditable="true"><h4><span style="font-family: Comfortaa, cursive;">CLÁUSULA DÉCIMA - DA ASSINATURA ELETRÔNICA</span></h4></div></h1>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        <div class="ui-draggable"><div contenteditable="true">
        <p></p><hr><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
        ...
        <div class="ui-draggable"><div style="text-align: justify;" contenteditable="true">
        <p style="text-align: justify;"></p><div class="edit" contenteditable="true"><p><b>11.1 - </b>As&nbsp;<span style="color: inherit;"><b>PARTES</b>&nbsp;confirmam,&nbsp;via assinatura eletrônica, nos moldes do art. 10 da MP 2.200/01 em vigor no Brasil, que estão de De Acordo com o presente CONTRATO, e, por estarem plenamente cientes dos termos, reafirmam seus deveres de observarem e fazerem cumprir as cláusulas aqui estabelecidas, em vista de que podem acessar a via do contrato através do endereço https://secure.d4sign.com.br e gerar versão impressa do mesmo, considerado o fato de já terem o recebido por e-mail.</span></p></div><p></p>
        </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>                        			<div class="ui-draggable"><link href="//fonts.googleapis.com/css?family=Abel" rel="stylesheet" property="stylesheet" type="text/css"><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div><div class="ui-draggable"><link href="//fonts.googleapis.com/css?family=Comfortaa" rel="stylesheet" property="stylesheet" type="text/css"><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>                        			<div class="ui-draggable"><link href="//fonts.googleapis.com/css?family=Sanchez" rel="stylesheet" property="stylesheet" type="text/css"><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>                        			</div>
