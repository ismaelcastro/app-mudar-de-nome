...
<body>
    ...
    <div class="ui-draggable"><div contenteditable="true">
    <p><br></p>
    </div><div class="row-tool" style="right: auto; left: -37px; display: none;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
    <div class="ui-draggable"><div contenteditable="true">
    <p><br></p>
    </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
    ...
    na Cláusula 1.1, o(a)&nbsp;<b>CONTRATANTE</b> pagará ao <b>CONTRATADO</b><span style="color: inherit;">, honorários no valor de <b>R$</b></span><b>&nbsp;<span class="VALOR_TOTAL token_d4s">{{$amount}}</span>&nbsp;</b>(<span class="EXTENSO token_d4s"><i>{{$by_extenso}}</i></span>)&nbsp;pagos em<b>&nbsp;<span class="N_PARCELAS token_d4s">{{$installments}}</span>&nbsp;&nbsp;</b>parcelas de igual valor através de boleto bancário com vencimentos para todo dia<b>&nbsp;<span class="VENCIMENTO token_d4s">{{$expiration_day}}</span>&nbsp;</b>de cada mês subsequente à assinatura do presente instrumento.</p></div><p></p>
    </div><div class="row-tool" style="right: auto; left: -37px;"><div class="row-handle"><i class="cb-icon-move"></i></div><div class="row-html"><i class="cb-icon-code"></i></div><div class="row-copy"><i class="cb-icon-plus"></i></div><div class="row-remove"><i class="cb-icon-cancel"></i></div></div></div>
...
<script>
    function executa_acao(){
        var div = $('#contentarea')[0];
        var onde_estou = div.scrollTop;
        var tamanho_tela = div.scrollHeight;
        //console.log(onde_estou);
        //console.log(tamanho_tela);
        if(onde_estou>0){
            var percent = onde_estou/(tamanho_tela/100);
            percent = parseInt(percent);
            if(percent >= 80){
                $('#agree-box', window.parent.document).show();
            }else{
                $('#agree-box', window.parent.document).hide();
            }
        }else{
            $('#agree-box', window.parent.document).hide();
        }
