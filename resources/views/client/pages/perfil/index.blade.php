                ...
                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table align-middle table-row-dashed gy-5 dataTable no-footer"
                                            ...
                                            <tr class="odd">
                                                <!--begin::order=-->
                                                <td>
                                                    <a href="{{ route("client.pedido.detalhes") }}" class="text-gray-600 text-hover-primary mb-1">#15400</a>
                                                </td>
                                                <!--end::order=-->
                                                <!--begin::Status=-->
                                                <td>
                    ...
                    <div class="tab-pane fade" id="kt_ecommerce_customer_general" role="tabpanel">
                        ...
                        <div class="card pt-4 mb-6 mb-xl-9">
                            ...
                            <div class="card-body pt-0 pb-5">
                                <!--begin::Form-->
                                <form id="kt_ecommerce_customer_profile"
                                    ...
                                    <div class="mb-7">
                                        ...
                                        <div class="mt-1">
                                            ...
                                            <div class="image-input image-input-outline" data-kt-image-input="true"
                                                 style="background-image: url({{ asset("metronic/media/avatars/300-1.jpg") }})">
                                    ...
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="email" class="form-control form-control-solid" placeholder="" name="email" value="client@email">
                                        <!--end::Input-->
                            ...
                            <div class="modal-body py-10 px-lg-17">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_update_address_scroll"
                                    ...
                                    <div class="fw-bolder fs-3 rotate collapsible collapsed mb-7" data-bs-toggle="collapse"
                                         ...
                                         aria-controls="kt_modal_update_address_billing_info">Detalhes
                                    ...
                                    <div id="kt_modal_update_address_billing_info" class="collapse show">
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="addresscep" value="">
                                            <!--end::Input-->
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="addressstreet">
                                            <!--end::Input-->
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        </div>
                                        <!--end::Input group-->
                                        ...
                                        <div class="row g-9 mb-7">
                                            ...
                                            <div class="col-md-6 fv-row fv-plugins-icon-container">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input class="form-control form-control-solid" placeholder="" name="addressstate" value="">
                                                <!--end::Input-->
                                                <div class="fv-plugins-message-container invalid-feedback">
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-flex flex-column mb-7 fv-row fv-plugins-icon-container">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid" placeholder="" name="addresscity"
                                                   value="Melbourne">
                                            <!--end::Input-->
                                            <div class="fv-plugins-message-container invalid-feedback">
                                            </div>
