...
<div class="row p-b-30">
    ...
    <div class="col-12 ico-money p-b-30">        
        <h2>Financeiro - "Ad Exitum"</h2>
        <p>
            Sua contratação foi realizada na modalidade "Ad Exitum", ou seja, o pagamento de honorários advocatícios será realizado somente após a sentença procedente.
        </p>
    </div>  
    <div class="col-8 col-12-xsmall">
        <div class="row gtr-uniform">
            <div class="col-11">
                ...
                <div class="row gtr-uniform ico-forma-contract" style="display: none">
                    <div class="col-5 col-10-xsmall">
                        <strong>Valor dos Honorários Advocatícios</strong>
                    </div>
                    <div class="col-5 col-10-xsmall">
                        <select name="dia-nascimento">
...
@section('class_body') body-martelo @endsection
