...
<div class="row p-b-30">
    <ul class="breadcrumb">
        ...
        <li><a href="javascript:void(0);">Documentos Pessoais</a></li>
        <li>Thiago Ratsbone</li>
    </ul>
    <div class="col-12 ico-cracha p-b-30">        
        <h2>Envio de Documentos</h2>
        <p>
            Fique atento para que os documentos enviados sejam anexados nos campos corretos.
        </p>
    </div>  
        ...
        <div class="row gtr-uniform">
            <div class="col-11">
                ...
                <div class="box-upload m-b-25">
                    ...
                    <p class="m-b-0">Frente e Verso.</p>
                </div>
                ...
                <div class="box-upload m-b-25">
                    <a href="javascript:void(0);" data-toggle="modal" data-target="#uploadCertidaoCasamentoModal" class="box-input-file">
    ...
    <div class="col-4 col-12-xsmall borda-esquerda">
        ...
        <div class="box-accordion">
            <h3 class="accordion">A Certidão deve ser atualizada?</h3>
        ...
        <div class="box-accordion">
            <h3 class="accordion">Por que devo apresentar a Certidão de Nascimento?</h3>
            <div class="accordion" data-id="2">
                <p> Lorem Ipsum tem sido o padrão desde a Idade Média. Um pintor teria peças mistas de texto em um livro exemplar e é este texto que nós usamos hoje. Outra versão diz que este é um trecho do livro de Cícero: "" De Finibus Bonorum e malorum "" seções 1.10.32 / 1.10.33. Este livro, muito popular durante a Renascença, é um tratado sobre a teoria da ética. </p>
            </div>
        </div>
        <div class="box-accordion">
            <h3 class="accordion">Para que serve o Comprovante de Residência?</h3>
