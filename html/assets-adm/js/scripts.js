...
function init_mask(){
  ...
  $('.money_pt-br').mask('#.##0,00', {reverse: true});
  $('.money_en').mask('###0.00', {reverse: true});
...
function upload_user(obj,action,recebe,folder,user_id){
    var formdata = false;
    if (window.FormData) {
    ...
    for ( ; i < len; i++ ) {
        ...
        $.ajax({
            ...
            success: function (str) {
                ...
                ajaxSaveUserPicture(user_id, nameImage, token, recebe);
                if(str.success){
